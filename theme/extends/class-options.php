...
namespace fwb\Theme\Extends;

use fwb\Theme\Components\Controls;
	...
	public function render_control( $args ) {
		...
		if ( $condition_met ) {
			if ( ! empty( $args['options'] ) ) {
				Controls::$control_type( $field_id, $value, $args['options'], $default );
			} else {
				Controls::$control_type( $field_id, $value, $default );
			}
		}
	}
}
